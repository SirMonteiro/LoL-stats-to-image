...
app_server = WSGIServer(('localhost', 3000), app)
...
lol_api_key = getenv('lol_api_key')
lol = LolWatcher(lol_api_key)
lol_region = getenv('lol_region')
lol_summonernick = getenv('lol_summonernick')
...
if __name__ == '__main__':
    ...
    Thread(target = app_server.serve_forever()).start()